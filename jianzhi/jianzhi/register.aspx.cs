        ...
        else
        {
            try
            {
                ...
                if(CheckBox1.Checked){
                    string strSql = "insert into userlist values('" + txtname.Text.Trim() + "','" + txtpsw.Text.Trim() +"','"+ddlproblem.Text.Trim()+ "','"+txtanswer.Text.Trim()+"','"+CheckBox1.Text+"')";
                    SqlCommand cmd = new SqlCommand(strSql, conn);
                    cmd.ExecuteNonQuery();
                }
                if(CheckBox2.Checked){
                    string strSql = "insert into userlist values('" + txtname.Text.Trim() + "','" + txtpsw.Text.Trim() +"','"+ddlproblem.Text.Trim()+ "','"+txtanswer.Text.Trim()+"','"+CheckBox2.Text+"')";
                    SqlCommand cmd = new SqlCommand(strSql, conn);
                    cmd.ExecuteNonQuery();
                }                
