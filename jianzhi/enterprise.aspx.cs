...
public partial class jianzhi_enterprise : System.Web.UI.Page
{
    ...
    protected void btnpublish_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            conn.Open();
            SqlCommand cmd = new SqlCommand("insert into company values('" + name + "','" + txtcompany.Text.Trim() + "','" + ddltype.Text + "','" + ddlproperty.Text + "','" + ddlsize.Text + "','" + txtaddress.Text + "','" + txtSdescribe.Text + "','" + pic.ImageUrl + "')", conn);
            cmd.ExecuteNonQuery();
            SqlCommand cmd1 = new SqlCommand("select * from company where uname='" + name + "'", conn);
