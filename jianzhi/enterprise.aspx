...
<body style="text-align:center">
    ...
    <div>
       ...
       <div class="h2">
        <asp:Label ID="Label3" runat="server" Text="公司行业："></asp:Label> &nbsp;
        ...
        <asp:DropDownList ID="ddlproperty" runat="server" Width="144px">
       ...
       <div class="h2">
        <asp:Label ID="Label5" runat="server" Text="公司规模:"></asp:Label> &nbsp;
        <asp:DropDownList ID="ddlsize" runat="server" Width="144px">
        ...
        <div class="h2">
        &nbsp;<asp:Label ID="Label6" runat="server" Text="公司地址:"></asp:Label> &nbsp;
        <asp:TextBox ID="txtaddress" runat="server"></asp:TextBox>
        </div><br />
        <div style="text-align:right;width:650px" >
            <asp:Label ID="Label7" runat="server" Text="公司介绍：" style="font-weight: 700"></asp:Label> &nbsp;
        </div>
         <div class="h2">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:FileUpload ID="pic_upload" runat="server" /><asp:Label ID="lbl_pic" runat="server" class="pic_text"></asp:Label>
        ...
        <div class="pic_image">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Image ID="pic" runat="server" Height="150px" Width="150px" /></div>
        </div><br /><br />
        <div class="h2">
