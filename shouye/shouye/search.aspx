<%@ Page Language="C#" AutoEventWireup="true" CodeFile="search.aspx.cs" Inherits="zhuye" %>
<!DOCTYPE html>
    ...
    <form id="form1" runat="server">
          ...
          <div id="yc_tnav">
            <div class="page clear_no">
                ...
                <ul class="tnav_wrap">
                    ...
                    <li><asp:LinkButton ID="LinkButtonPublic" runat="server">发布职位</asp:LinkButton></li>
                    <li><a href="#" data-selectid="freejob">学生投诉</a></li>
                </ul>
        ...
        <div class="main">
         ...
         <div style="background:#ffffff;">
            ...
            <Columns>
                <asp:HyperLinkField DataNavigateUrlFields="position_id" DataTextField="position" HeaderText="职位">
